...
d_1_6 = 2
u_1_6 = runif(n_samples)
x_1_6 = matrix(runif(n_samples * d_1_6), n_samples, d_1_6)
beta_1_6 = matrix(seq(k_1_6 * d_1_6), d_1_6, k_1_6)
x_beta_1_6 = x_1_6 %*% beta_1_6
logit_inv_1_6 = 1/(1 + exp(-(beta_1_6 * x_1_6)))
y_1_6 = u_1_6 < logit_inv_1_6
...
multi_logit_avg = lapply(multi_logit_out, function(x) colMeans(as.matrix(x)))

multi_logit_ggdata =
  data.frame(
    alpha = multi_logit_out$alpha,
